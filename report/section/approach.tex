...
from.~\mvf{unclear, please elaborate} Raffetseder {\em et al.} used the
...
of 10 to 100 times between emulated and real environments \mvf{incoherent
  sentence}. Thus, the difference is large enough to detect virtual
environments.
